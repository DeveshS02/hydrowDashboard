...
import WelcomeContainer from "./Welcommodal";
import TooltipContainer from "./tooltipstatus";
import Tooltipindex from "./tooltipindex";
  ...
  const fetchNodesData = useCallback(async () => {
    ...
    try {
      ...
      const filterNodesByLocation = (nodes) =>
        nodes.filter((node) => node.location === userData.location);
